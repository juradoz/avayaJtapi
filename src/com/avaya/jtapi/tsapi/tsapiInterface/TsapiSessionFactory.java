 ...
 public abstract class TsapiSessionFactory
 {
   ...
   public static TsapiSessionFactory getTsapiSessionFactory(Properties props)
   {
     ...
     if ((props != null) && (props.get("com.avaya.jtapi.tsapi.tsapiInterface.TsapiSessionFactory.sessionFactory") != null)) {
       className = (String)props.get("com.avaya.jtapi.tsapi.tsapiInterface.TsapiSessionFactory.sessionFactory");
     }
       ...
       try
       {
         ...
         do
         {
           ...
           for (int i = 0; i < replyList.length; ++i)
           {
             ...
             log.debug("SERVICE[" + i + "]: " + replyList[i].getServerName());
...
continue;
       ...
       int index = alternateTlinkEntriesList.getAlternateTlinkIndex(tlink, nameAddr.getServerName());
     ...
     throw new TsapiPlatformException(4, 0, "server " + new ArrayList(servers) + " with tlink '" + tlink + "' not found");
   }
 }
