 ...
 public final class TSErrorMap
 {
     ...
     throws TsapiInvalidArgumentException, TsapiProviderUnavailableException, TsapiPrivilegeViolationException, TsapiResourceUnavailableException
   {
     ...
     if (acsError == 23)
     {
       throw new TsapiProviderUnavailableException(1, acsError, errorString);
     }
     if (((acsError >= 25) && (acsError <= 36)) || (acsError == 44) || ((acsError >= 49) && (acsError <= 65)) || ((acsError >= 111) && (acsError <= 118)))
     {
       throw new TsapiPrivilegeViolationException(1, acsError, 0, errorString);
     }
     if (acsError == 42)
     {
       throw new TsapiResourceUnavailableException(1, acsError, 0, errorString);
     }
     if (acsError == 119)
     {
     ...
     throws TsapiInvalidStateException, TsapiInvalidArgumentException, TsapiInvalidPartyException, TsapiPrivilegeViolationException, TsapiResourceUnavailableException
   {
     ...
     {
       throw new TsapiInvalidStateException(2, cstaError, null, 0, 0, errorString);
     }
     if ((cstaError == 3) || (cstaError == 4))
     {
       throw new TsapiInvalidArgumentException(2, cstaError, errorString);
     }
     if ((cstaError == 5) || (cstaError == 6) || (cstaError == 7) || (cstaError == 14))
     {
       throw new TsapiInvalidPartyException(2, cstaError, 0, errorString);
     }
     if ((cstaError == 8) || (cstaError == 9) || (cstaError == 10) || (cstaError == 19))
     {
       throw new TsapiPrivilegeViolationException(2, cstaError, 0, errorString);
     }
     if ((cstaError >= 31) && (cstaError <= 44))
     {
       throw new TsapiResourceUnavailableException(2, cstaError, 0, errorString);
     }
