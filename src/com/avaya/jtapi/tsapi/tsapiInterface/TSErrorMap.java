...
public final class TSErrorMap {
	...
	public static void throwCSTAException(final int cstaError)
		...
		final String errorString = "CSTA Error: " + String.valueOf(cstaError);
