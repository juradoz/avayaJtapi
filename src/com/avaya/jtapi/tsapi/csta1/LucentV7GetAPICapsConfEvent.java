 ...
 public final class LucentV7GetAPICapsConfEvent extends LucentV5GetAPICapsConfEvent
 {
   ...
   public void decodeMembers(InputStream memberStream)
   {
     ...
     this.administeredSwitchSoftwareVersion = ASNIA5String.decode(memberStream);
   ...
   public void encodeMembers(OutputStream memberStream)
   {
     ...
     ASNIA5String.encode(this.administeredSwitchSoftwareVersion, memberStream);
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(ASNIA5String.print(this.switchVersion, "switchVersion", indent));
     lines.addAll(ASNBoolean.print(this.sendDTMFTone, "sendDTMFTone", indent));
     lines.addAll(ASNBoolean.print(this.enteredDigitsEvent, "enteredDigitsEvent", indent));
 
     lines.addAll(ASNBoolean.print(this.queryDeviceName, "queryDeviceName", indent));
     lines.addAll(ASNBoolean.print(this.queryAgentMeas, "queryAgentMeas", indent));
     lines.addAll(ASNBoolean.print(this.querySplitSkillMeas, "querySplitSkillMeas", indent));
 
     lines.addAll(ASNBoolean.print(this.queryTrunkGroupMeas, "queryTrunkGroupMeas", indent));
 
     lines.addAll(ASNBoolean.print(this.queryVdnMeas, "queryVdnMeas", indent));
     lines.addAll(ASNBoolean.print(this.singleStepConference, "singleStepConference", indent));
 
     lines.addAll(ASNBoolean.print(this.selectiveListeningHold, "selectiveListeningHold", indent));
 
     lines.addAll(ASNBoolean.print(this.selectiveListeningRetrieve, "selectiveListeningRetrieve", indent));
 
     lines.addAll(ASNBoolean.print(this.setBillingRate, "setBillingRate", indent));
     lines.addAll(ASNBoolean.print(this.queryUCID, "queryUCID", indent));
     lines.addAll(ASNBoolean.print(this.chargeAdviceEvent, "chargeAdviceEvent", indent));
 
     lines.addAll(ASNBoolean.print(this.reserved1, "reserved1(singleStepTransfer)", indent));
     lines.addAll(ASNBoolean.print(this.reserved2, "reserved2(monitorCallsViaDevice)", indent));
     lines.addAll(ASNInteger.print(this.maxDeviceHistoryCount, "maxDeviceHistoryCount", indent));
 
     lines.addAll(ASNIA5String.print(this.administeredSwitchSoftwareVersion, "administeredSwitchSoftwareVersion", indent));
 
     lines.addAll(ASNIA5String.print(this.switchSoftwareVersion, "switchSoftwareVersion", indent));
