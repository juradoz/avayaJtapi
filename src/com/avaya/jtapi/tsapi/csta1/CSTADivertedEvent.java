 ...
 public final class CSTADivertedEvent extends CSTAUnsolicited
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(CSTAExtendedDeviceID.print(this.divertingDevice, "divertingDevice", indent));
     lines.addAll(CSTAExtendedDeviceID.print(this.newDestination, "newDestination", indent));
