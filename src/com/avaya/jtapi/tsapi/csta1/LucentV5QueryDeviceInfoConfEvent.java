 ...
 public final class LucentV5QueryDeviceInfoConfEvent extends LucentQueryDeviceInfoConfEvent
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(LucentExtensionClass.print(this.associatedClass, "associatedClass", indent));
     lines.addAll(DeviceID.print(this.associatedDevice, "associatedDevice", indent));
