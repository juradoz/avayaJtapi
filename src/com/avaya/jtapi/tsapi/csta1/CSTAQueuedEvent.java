 ...
 public final class CSTAQueuedEvent extends CSTAUnsolicited
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(CSTAConnectionID.print(this.queuedConnection, "queuedConnection", indent));
     lines.addAll(CSTAExtendedDeviceID.print(this.queueingDevice, "queueingDevice", indent));
     ...
     lines.addAll(ASNInteger.print(this.numberQueued, "numberQueued", indent));
