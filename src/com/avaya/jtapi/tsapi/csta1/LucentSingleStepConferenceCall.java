 ...
 public final class LucentSingleStepConferenceCall extends LucentPrivateData
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(DeviceID.print(this.deviceToBeJoin, "deviceToBeJoin", indent));
     lines.addAll(ParticipationType.print(this.participationType, "participationType", indent));
     lines.addAll(ASNBoolean.print(this.alertDestination, "alertDestination", indent));
