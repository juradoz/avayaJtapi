 ...
 public final class CSTAEstablishedEvent extends CSTAUnsolicited
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(CSTAConnectionID.print(this.establishedConnection, "establishedConnection", indent));
     lines.addAll(CSTAExtendedDeviceID.print(this.answeringDevice, "answeringDevice", indent));
