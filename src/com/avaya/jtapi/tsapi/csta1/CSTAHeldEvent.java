...
public final class CSTAHeldEvent extends CSTAUnsolicited {
	...
	public Collection<String> print() {
		...
		lines.addAll(CSTAConnectionID.print(this.heldConnection,
				"heldConnection", indent));
		lines.addAll(CSTAExtendedDeviceID.print(this.holdingDevice,
				"holdingDevice", indent));
