 ...
 public final class LucentQueryAcdSplitConfEvent extends LucentPrivateData
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(ASNInteger.print(this.availableAgents, "availableAgents", indent));
     lines.addAll(ASNInteger.print(this.callsInQueue, "callsInQueue", indent));
     lines.addAll(ASNInteger.print(this.agentsLoggedIn, "agentsLoggedIn", indent));
