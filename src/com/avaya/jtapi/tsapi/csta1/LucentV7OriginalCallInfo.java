 ...
 public final class LucentV7OriginalCallInfo extends LucentV5OriginalCallInfo
 {
   ...
   public static LucentOriginalCallInfo decode(InputStream in)
   {
     ...
     _this.doDecode(in);
     if ((_this.callingDevice_asn == null) && (_this.calledDevice_asn == null) && (_this.trunkGroup == null) && (_this.trunkMember == null) && (_this.lookaheadInfo == null) && (_this.userEnteredCode == null) && (_this.userInfo == null) && (_this.ucid == null) && (_this.callOriginatorInfo == null) && (_this.asn_deviceHistory == null))
     {
       return null;
     }
     return _this;
   ...
   public static Collection<String> print(LucentV7OriginalCallInfo _this, String name, String _indent)
   {
     ...
     lines.addAll(CSTADeviceHistoryData.print(_this.asn_deviceHistory, "deviceHistoryEntry", indent));
