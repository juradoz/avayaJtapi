 ...
 public class LucentSendDTMFTone extends LucentPrivateData
 {
   ...
   public Collection<String> print()
   {
     ...
     lines.addAll(LucentConnIDList.print(this.receivers, "receivers", indent));
     lines.addAll(ASNIA5String.print(this.tones, "tones", indent));
     lines.addAll(ASNInteger.print(this.toneDuration, "toneDuration", indent));
     lines.addAll(ASNInteger.print(this.pauseDuration, "pauseDuration", indent));
   ...
   public int getPauseDuration() { return this.pauseDuration; }
