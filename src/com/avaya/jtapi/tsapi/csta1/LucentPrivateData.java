	...
	public static LucentPrivateData create(CSTAPrivate priv, int tsType) {
		...
		if (priv != null) {
			...
			case 69:
				...
				break;
			case 70:
				lpriv = LucentSelectiveListeningRetrieveConfEvent
						.decode(decodeStream);
				break;
			case 68:
				lpriv = LucentSelectiveListeningHoldConfEvent
						.decode(decodeStream);
				break;
			case 67:
			...
			case 65:
				...
				break;
			case 66:
				lpriv = LucentSingleStepConferenceCallConfEvent
						.decode(decodeStream);
				break;
			case 142:
				...
				break;
			case 143:
				lpriv = LucentSingleStepTransferCallConfEvent
						.decode(decodeStream);
				break;
			case 90:
			...
			case 139:
				...
				break;
			case 140:
				lpriv = LucentUseUnifiedDesktopLicenseConfEvent
						.decode(decodeStream);
				break;
			case 73:
 ...
 * com.avaya.jtapi.tsapi.csta1.LucentPrivateData JD-Core Version: 0.5.4
 */