 ...
 public final class CSTARouteRequestExtEv extends CSTARequest
 {
   ...
   public Collection<String> print() {
     ...
     lines.addAll(CSTAExtendedDeviceID.print(this.currentRoute, "currentRoute", indent));
     lines.addAll(CSTAExtendedDeviceID.print(this.callingDevice, "callingDevice", indent));
     lines.addAll(CSTAConnectionID.print(this.routedCall, "routedCall", indent));
     lines.addAll(SelectValue.print(this.routedSelAlgorithm, "routedSelAlgorithm", indent));
