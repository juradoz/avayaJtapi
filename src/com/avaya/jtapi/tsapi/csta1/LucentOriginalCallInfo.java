 ...
 public class LucentOriginalCallInfo extends LucentPrivateData
 {
   ...
   public static LucentOriginalCallInfo decode(InputStream in)
   {
     ...
     _this.doDecode(in);
     if ((_this.callingDevice_asn == null) && (_this.calledDevice_asn == null) && (_this.trunkGroup == null) && (_this.trunkMember == null) && (_this.lookaheadInfo == null) && (_this.userEnteredCode == null) && (_this.userInfo == null))
     {
       return null;
     }
     return _this;
   ...
   public static Collection<String> print(LucentOriginalCallInfo _this, String name, String _indent)
   {
     ...
     lines.addAll(LucentLookaheadInfo.print(_this.lookaheadInfo, "lookaheadInfo", indent));
