...
public final class CSTAMessageWaitingEvent extends CSTAUnsolicited {
	...
	public Collection<String> print() {
		...
		lines.addAll(CSTAExtendedDeviceID.print(this.deviceForMessage,
				"deviceForMessage", indent));

		lines.addAll(CSTAExtendedDeviceID.print(this.invokingDevice,
				"invokingDevice", indent));

		lines.addAll(ASNBoolean.print(this.messageWaitingOn,
				"messageWaitingOn", indent));
