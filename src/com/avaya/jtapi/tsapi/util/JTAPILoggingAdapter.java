     ...
     if (somethingChanged) {
       ...
       if ((isTraceLoggingEnabled()) || (isErrorLoggingEnabled())) {
         if (!isErrorLoggingEnabled())
           loggingProperties.put("log4j.logger.com.avaya.jtapi.tsapi", traceLoggerLevel + ",defaultAppender");
         else if (!isTraceLoggingEnabled())
           loggingProperties.put("log4j.logger.com.avaya.jtapi.tsapi", "ERROR,errorAppender");
         else {
           loggingProperties.put("log4j.logger.com.avaya.jtapi.tsapi", traceLoggerLevel + ",defaultAppender,errorAppender");
         }
       }
       if (isTraceLoggingEnabled())
       {
         ...
         {
           loggingProperties.put("log4j.appender.defaultAppender", "org.apache.log4j.RollingFileAppender");
           loggingProperties.put("log4j.appender.defaultAppender.File", altTraceFile);
 
           if (traceFileCount != null)
             loggingProperties.put("log4j.appender.defaultAppender.MaxBackupIndex", Integer.valueOf(Integer.parseInt(traceFileCount) - 1));
           else {
             loggingProperties.put("log4j.appender.defaultAppender.MaxBackupIndex", "9");
           }
           if (traceFileSize != null)
             loggingProperties.put("log4j.appender.defaultAppender.MaxFileSize", traceFileSize);
           else
             loggingProperties.put("log4j.appender.defaultAppender.MaxFileSize", "50MB");
         }
         else
         {
           loggingProperties.put("log4j.appender.defaultAppender", "org.apache.log4j.ConsoleAppender");
           loggingProperties.put("log4j.appender.defaultAppender.Target", "System.out");
         }
 
         loggingProperties.put("log4j.appender.defaultAppender.layout", "org.apache.log4j.PatternLayout");
         loggingProperties.put("log4j.appender.defaultAppender.layout.ConversionPattern", "%d [%t] %-5p %c{1} - %m%n");
       }
 
       if (isErrorLoggingEnabled())
       {
         loggingProperties.put("log4j.appender.errorAppender", "org.apache.log4j.RollingFileAppender");
         loggingProperties.put("log4j.appender.errorAppender.File", errorFile);
         loggingProperties.put("log4j.appender.errorAppender.threshold", "ERROR");
 
         if (errorFileCount != null)
           loggingProperties.put("log4j.appender.errorAppender.MaxBackupIndex", Integer.valueOf(Integer.parseInt(errorFileCount) - 1));
         else {
           loggingProperties.put("log4j.appender.errorAppender.MaxBackupIndex", "9");
         }
         if (errorFileSize != null)
           loggingProperties.put("log4j.appender.errorAppender.MaxFileSize", errorFileSize);
         else
           loggingProperties.put("log4j.appender.errorAppender.MaxFileSize", "50MB");
         loggingProperties.put("log4j.appender.errorAppender.layout", "org.apache.log4j.PatternLayout");
         loggingProperties.put("log4j.appender.errorAppender.layout.ConversionPattern", "%d [%t] %-5p %c{1} - %m%n");
       }
       if (isPerformanceLoggingEnabled()) {
         loggingProperties.put("log4j.logger.jtapi.performanceLogger", Level.TRACE + ",performanceAppender");
         loggingProperties.put("log4j.appender.performanceAppender", "org.apache.log4j.RollingFileAppender");
         loggingProperties.put("log4j.appender.performanceAppender.File", perfFile);
 
         if (perfFileCount != null)
           loggingProperties.put("log4j.appender.performanceAppender.MaxBackupIndex", Integer.valueOf(Integer.parseInt(perfFileCount) - 1));
         else {
           loggingProperties.put("log4j.appender.performanceAppender.MaxBackupIndex", "9");
         }
         if (perfFileSize != null)
           loggingProperties.put("log4j.appender.performanceAppender.MaxFileSize", perfFileSize);
         else
           loggingProperties.put("log4j.appender.performanceAppender.MaxFileSize", "50MB");
         loggingProperties.put("log4j.appender.performanceAppender.layout", "org.apache.log4j.PatternLayout");
         loggingProperties.put("log4j.appender.performanceAppender.layout.ConversionPattern", "%d [%t] %-5p %c{1} - %m%n");
       }
       if ((isTraceLoggingEnabled()) || (isErrorLoggingEnabled()) || (isPerformanceLoggingEnabled())) {
         ...
         theLogger.info("Logging properties = " + loggingProperties.toString());
   ...
   public static void setTraceLoggerLevel(String traceLoggerLevel)
   {
     ...
     try
     {
       ...
       if ((debugLevel >= 0) && (debugLevel <= 7)) {
         ...
         Logger theLogger = Logger.getLogger(JTAPILoggingAdapter.class);
         theLogger.error("JTAPILoggingAdapter - Invalid value for debugLevel. Enter a value between 1 and 7");
         theLogger.error("Error occured while reading logger level property. You entered : " + traceLoggerLevel);
       } else {
         System.out.println("JTAPILoggingAdapter - Invalid value for debugLevel. Enter a value between 1 and 7");
         System.out.println("Error occured while reading logger level property. You entered : " + traceLoggerLevel);
       }
     }
     catch (Exception e) {
       if (JtapiUtils.isLog4jConfigured()) {
         Logger theLogger = Logger.getLogger(JTAPILoggingAdapter.class);
         theLogger.error("JTAPILoggingAdapter - Invalid value for debugLevel. Enter a value between 1 and 7");
         theLogger.error("Error occured while reading logger level property. You entered : " + traceLoggerLevel, e);
       } else {
         System.out.println("JTAPILoggingAdapter - Invalid value for debugLevel. Enter a value between 1 and 7");
         System.out.println("Error occured while reading logger level property. You entered : " + traceLoggerLevel);
         e.printStackTrace();
