 ...
 public class JtapiUtils
 {
   ...
   public static Collection<InetSocketAddress> parseTelephonyServerEntry(String value, int defaultPort) { Collection telephonyServers = new LinkedHashSet();
       ...
       if (tokens.length > 0) {
         ...
         if (tokens.length > 1) {
           try {
             ...
             log.error("Error getting port from string fragment'" + value + "':" + e.getMessage(), e);
           }
         }
