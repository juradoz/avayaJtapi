 ...
 public class CallEventUtil
 {
   public static MetaEvent[] getListenerMetaObject(int cause, CallEventParams callParams, boolean isSnapshot)
   {
     ...
     if (isSnapshot) {
       ...
       metaEventPair[0] = new SingleCallMetaEventImpl(callParams, metaEventId);
       metaEventPair[1] = new SingleCallMetaEventImpl(callParams, metaEventId + 1);
     } else {
       switch (cause)
       {
       case 207:
       ...
       if (isMultiCallMeta) {
         ...
         metaEventPair[0] = new MultiCallMetaEventImpl(callParams, metaEventId);
         metaEventPair[1] = new MultiCallMetaEventImpl(callParams, metaEventId + 1);
       } else {
         metaEventPair = new SingleCallMetaEventImpl[2];
         metaEventPair[0] = new SingleCallMetaEventImpl(callParams, metaEventId);
         metaEventPair[1] = new SingleCallMetaEventImpl(callParams, metaEventId + 1);
