   ...
   implements LucentACDManagerAddress
 {
   public boolean equals(Object obj)
   {
     ...
     {
       return this.tsDevice.equals(((LucentACDManagerAddressImpl)obj).tsDevice);
     }
     ...
     throws TsapiInvalidArgumentException
   {
     ...
     TsapiTrace.traceEntry("LucentACDManagerAddressImpl[TSProviderImpl tsProvider, String number]", this);
     TsapiTrace.traceExit("LucentACDManagerAddressImpl[TSProviderImpl tsProvider, String number]", this);
   }
