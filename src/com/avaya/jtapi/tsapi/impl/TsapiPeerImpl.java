   ...
   implements ITsapiPeer
 {
   ...
   public final Provider getProvider(String providerString) {
     ...
     TsapiProvider tsapiProvider = new TsapiProvider(providerString, this.vendors);
     this.vendors = null;
     Provider provider;
     if (tsapiProvider.tsProvider.isLucent()) {
       provider = (Provider)TsapiCreateObject.getTsapiObject(tsapiProvider.tsProvider, false);
     }
     else {
