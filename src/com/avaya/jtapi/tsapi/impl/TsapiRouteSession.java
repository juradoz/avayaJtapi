   ...
   implements ITsapiRouteSession, ITsapiCallInfo, PrivateData
 {
   ...
   private LucentRouteSelect createLucentRouteSelect(String callingDevice, String directAgentCallSplit, boolean priorityCalling, String destRoute, LucentUserCollectCode collectCode, LucentUserProvidedCode userProvidedCode, UserToUserInfo userInfo, short networkRedirectCallType)
   {
     ...
     if (provider != null)
     {
       ...
       {
         route = new LucentV7RouteSelect(callingDevice, directAgentCallSplit, priorityCalling, destRoute, collectCode, userProvidedCode, asn_uui, networkRedirectCallType);
       }
       else if (provider.isLucentV6()) {
         route = new LucentV6RouteSelect(callingDevice, directAgentCallSplit, priorityCalling, destRoute, collectCode, userProvidedCode, asn_uui);
       }
       else
       {
         route = new LucentRouteSelect(callingDevice, directAgentCallSplit, priorityCalling, destRoute, collectCode, userProvidedCode, asn_uui);
       }
     ...
     throws TsapiMethodNotSupportedException
   {
     ...
     try
     {
       LucentRouteSelect lrs = createLucentRouteSelect(null, null, priorityCall, null, null, null, userInfo, (short) 0);
     ...
     throws TsapiMethodNotSupportedException, TsapiInvalidArgumentException
   {
     ...
     try
     {
       ...
       LucentRouteSelect lrs = createLucentRouteSelect(null, calledAgent.getACDAddress().getName(), priorityCall, null, null, null, userInfo, (short) 0);
     ...
     throws TsapiMethodNotSupportedException
   {
     ...
     try
     {
       LucentUserCollectCode ucc = new LucentUserCollectCode((short)32, digitsToBeCollected, timeout, null, (short)11);
 
       LucentRouteSelect lrs = createLucentRouteSelect(null, null, priorityCall, null, ucc, null, userInfo, (short)0);
     ...
     TsapiTrace.traceExit("selectRouteAndCollect[String routeSelected, int digitsToBeCollected, int timeout, boolean priorityCall, UserToUserInfo userInfo]", this);
   }
     ...
     throws TsapiMethodNotSupportedException
   {
     ...
     try
     {
       ...
       if (digits == null) upc = null; else {
         upc = new LucentUserProvidedCode((short) 17, digits);
       }
       LucentRouteSelect lrs = createLucentRouteSelect(null, null, priorityCall, null, null, upc, userInfo, (short) 0);
     ...
     TsapiTrace.traceExit("selectRouteWithDigits[String routeSelected, String digits, boolean priorityCall, UserToUserInfo userInfo]", this);
   }
   ...
   public final CallCenterTrunk getTrunk()
   {
     ...
     try
     {
       ...
       if (tsTrunk != null)
       {
         trunk = (TsapiTrunk)TsapiCreateObject.getTsapiObject(tsTrunk, false);
     ...
     throws TsapiMethodNotSupportedException
   {
     ...
     try
     {
       LucentRouteSelect lrs = createLucentRouteSelect(null, null, false, null, null, null, userInfo, (short) 1);
       this.privData = lrs.makeTsapiPrivate();
       this.tsRouteSession.tsSelectRoute(routes, this.privData);
     }
     finally
