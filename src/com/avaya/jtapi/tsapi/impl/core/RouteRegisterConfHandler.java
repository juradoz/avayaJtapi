   ...
   implements ConfHandler
 {
   ...
   {
     if ((event == null) || (!(event.getEvent() instanceof CSTARouteRegisterReqConfEvent)))
     {
       return;
     }
 
     CSTARouteRegisterReqConfEvent routeRegisterConf = (CSTARouteRegisterReqConfEvent)event.getEvent();
