   ...
   implements SnapshotCallExtraConfHandler
 {
   ...
   public Object handleConf(boolean rc, Vector<TSEvent> _eventList, Object _privateData)
   {
     if (this.call.getNeedRedoSnapshotCall())
     {
       ...
       this.call.doSnapshot(((TSConnection)this.snapConnections.elementAt(0)).getConnID(), this, false);
       return null;
     }
     ...
     if (rc)
     {
       ...
       {
         TSConnection conn = (TSConnection)this.snapConnections.elementAt(i);
     ...
     {
       this.eventHandler.doCallMonitors(this.call, eventList, this.jtapiCause, this.privateData);
     }
