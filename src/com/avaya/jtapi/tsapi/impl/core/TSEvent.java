...
/* 196 */   private short snapshotCstaCause = -1;
/*     */ 
/*     */   public TransferredEventParams getTransferredEventParams()
/*     */   {
/*  97 */     return this.transferredEventParams;
/*     */   }
/*     */ 
/*     */   public void setTransferredEventParams(TransferredEventParams transferredEventParams)
/*     */   {
/* 104 */     this.transferredEventParams = transferredEventParams;
/*     */   }
/*     */ 
...
/*     */   {
/* 114 */     return this.eventTarget;
/*     */   }
/*     */ 
/*     */   public Object getPrivateData()
/*     */   {
/* 119 */     return this.privateData;
/*     */   }
/*     */ 
/*     */   public void setPrivateData(Object _privateData)
/*     */   {
/* 124 */     this.privateData = _privateData;
/*     */   }
/*     */ 
/*     */   public TSDevice getSkillDevice()
/*     */   {
/* 129 */     return this.skillDevice;
/*     */   }
/*     */ 
/*     */   public void setSkillDevice(TSDevice _skillDevice)
/*     */   {
/* 134 */     this.skillDevice = _skillDevice;
/*     */   }
/*     */ 
/*     */   TSEvent(int _eventType, Object _eventTarget)
/*     */   {
/* 140 */     this.eventType = _eventType;
/* 141 */     this.eventTarget = _eventTarget;
/* 142 */     this.privateData = null;
/*     */   }
/*     */ 
/*     */   public TSEvent(int _eventType, Object _eventTarget, Object _privateData, TSProviderImpl _provider)
/*     */   {
/* 150 */     this.eventType = _eventType;
/* 151 */     this.eventTarget = _eventTarget;
/*     */ 
/* 154 */     this.privateData = TsapiPromoter.promotePrivateEvent(_provider, _privateData);
/*     */   }
/*     */ 
/*     */   public TSEvent(int _eventType, Object _eventTarget, Object _privateData)
/*     */   {
/* 177 */     this(_eventType, _eventTarget, _privateData, null);
/*     */   }
/*     */ 
/*     */   public String toString() {
/* 181 */     return "eventTarget=" + this.eventTarget + ";eventType=" + this.eventType;
/*     */   }
/*     */ 
/*     */   public void setSnapshotCstaCause(short snapshotCstaCause)
/*     */   {
/* 202 */     this.snapshotCstaCause = snapshotCstaCause;
/*     */   }
/*     */ 
/*     */   public short getSnapshotCstaCause()
/*     */   {
/* 212 */     return this.snapshotCstaCause;
/*     */   }
/*     */ }

/* Location:           C:\Documents and Settings\Daniel Jurado\Meus documentos\My Dropbox\install\Avaya\jtapi-sdk-5.2.2.483\lib\ecsjtapia.jar
 * Qualified Name:     com.avaya.jtapi.tsapi.impl.core.TSEvent
