 ...
 public final class TSRouteSession
 {
     ...
     throws TsapiMethodNotSupportedException
   {
     ...
     {
       this.tsProvider.tsapi.selectRoute(this.tsDevice.getRegisterReqID(), this.routingCrossRefID, routeSelected[i], -2, "", true, reqPriv);
       try
       {
   ...
   public void tsEndRoute(int errorValue, CSTAPrivate reqPriv)
   {
     ...
     this.tsProvider.tsapi.routeEnd(this.tsDevice.getRegisterReqID(), this.routingCrossRefID, (short)cstaError, reqPriv);
   ...
   void setUEC(LucentUserEnteredCode _uec)
   {
     if (_uec == null)
       return;
     this.uec = TsapiPromoter.promoteUserEnteredCode(this.tsProvider, _uec);
   }
