   ...
   implements ConfHandler
 {
   ...
   {
     if ((event == null) || (!(event.getEvent() instanceof ACSSetHeartbeatIntervalConfEvent)))
     {
       return;
     }
 
     this.provider.setClientHeartbeatInterval(((ACSSetHeartbeatIntervalConfEvent)event.getEvent()).getHeartbeatInterval());
   }
 }
