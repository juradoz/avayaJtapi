   ...
   implements ConfHandler
 {
   ...
   public void handleConf(CSTAEvent event)
   {
     ...
     if (event.getPrivData() instanceof LucentQueryAgentStateConfEvent)
     {
       ...
       {
         _reasonCode = ((LucentV5QueryAgentStateConfEvent)event.getPrivData()).getReasonCode();
         if (event.getPrivData() instanceof LucentV6QueryAgentStateConfEvent)
         {
           int pendingWorkMode = ((LucentV6QueryAgentStateConfEvent)event.getPrivData()).getPendingWorkMode();
           ...
           _pendingReasonCode = ((LucentV6QueryAgentStateConfEvent)event.getPrivData()).getPendingReasonCode();
         }
       }
     }
     if (agentIsBusy)
     {
       this.agent.updateState(7, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
     }
     else
     {
       switch (agentState)
       {
       case 0:
         this.agent.updateState(3, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
         break;
       case 1:
         this.agent.updateState(2, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
         break;
       case 2:
         this.agent.updateState(4, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
         break;
       case 3:
         this.agent.updateState(5, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
         break;
       case 4:
         this.agent.updateState(6, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
         break;
       default:
         this.agent.updateState(0, _workMode, _reasonCode, _pendingState, _pendingReasonCode, _lucentworkmode, null);
       }
     }
   }
 }
