...
{
  public abstract IDomainDevice addCallToDomain(IDomainDevice paramIDomainDevice, IDomainCall paramIDomainCall);

  public abstract void removeCallFromDomain(IDomainCall paramIDomainCall);

  public abstract void removeAllCallsForDomain(IDomainDevice paramIDomainDevice);
 ...
 * Qualified Name:     com.avaya.jtapi.tsapi.impl.core.IDomainTracker
