 ...
 public class JtapiEventThreadManager
 {
   ...
   public static synchronized void initialize()
   {
     if (threadPoolExecutor == null) {
       ...
       threadPoolExecutor = new ThreadPoolExecutor(defaultValue, defaultValue, 200L, TimeUnit.MILLISECONDS, fifoBuffer, new JtapiEventThreadRejectionHandler());
     }
   }
   ...
   public static void execute(TsapiMonitor _obs) {
     if (threadPoolExecutor == null) {
       ...
       threadPoolExecutor.execute(new JtapiEventDeliveryThread(_obs, System.currentTimeMillis()));
     }
   }
