   ...
   implements ConfHandler
 {
   ...
   {
     if ((event == null) || (event.getPrivData() == null) || (!(event.getPrivData() instanceof LucentQueryAgentLoginConfEvent)))
     {
       return;
     }
     int xrefID = ((LucentQueryAgentLoginConfEvent)event.getPrivData()).getPrivEventCrossRefID();
