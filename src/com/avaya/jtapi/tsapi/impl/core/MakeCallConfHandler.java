   ...
   implements ConfHandler
 {
   ...
   public void handleConf(CSTAEvent event)
   {
     ...
     {
     case 24:
       this.newCall = ((CSTAMakeCallConfEvent)event.getEvent()).getNewCall();
       if (this.call.replyPriv instanceof LucentMakeCallConfEvent)
       {
         this.call.setUCID(((LucentMakeCallConfEvent)this.call.replyPriv).getUcid()); } break;
     case 26:
       this.newCall = ((CSTAMakePredictiveCallConfEvent)event.getEvent()).getNewCall();
       if (this.call.replyPriv instanceof LucentMakePredictiveCallConfEvent)
       {
         this.call.setUCID(((LucentMakePredictiveCallConfEvent)this.call.replyPriv).getUcid()); } break;
     case 14:
       this.newCall = ((CSTAConsultationCallConfEvent)event.getEvent()).getNewCall();
     ...
     TSDevice dialedDevice = this.call.getTSProviderImpl().createDevice(this.dialedDigits);
