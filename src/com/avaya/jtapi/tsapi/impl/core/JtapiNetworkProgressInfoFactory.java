 ...
 class JtapiNetworkProgressInfoFactory
 {
   static NetworkProgressInfo createNetworkProgressInfo(TSProviderImpl provider, LucentNetworkProgressInfo csta_obj)
   {
     ...
     {
       return promoteV7NetworkProgressInfo(provider, (LucentV7NetworkProgressInfo)csta_obj, null);
     }
     if (csta_obj instanceof LucentV5NetworkProgressInfo)
     {
       return promoteV5NetworkProgressInfo(provider, (LucentV5NetworkProgressInfo)csta_obj, null);
     }
   ...
   static NetworkProgressInfo promoteV5NetworkProgressInfo(TSProviderImpl provider, LucentV5NetworkProgressInfo oci_csta, V5NetworkProgressInfo obj)
   {
     ...
     trunk = TsapiPromoter.promoteTrunk(provider, oci_csta.getTrunkGroup(), oci_csta.getTrunkMember(), 2);
 
     if ((obj == null) && (trunkGroup == null) && (trunkMember == null) && (trunk == null))
     {
       return promoteNetworkProgressInfo(provider, oci_csta, null);
     }if ((obj == null) && (trunkGroup.equals("0")) && (trunkMember.equals("0")) && (trunk == null))
     {
       return promoteNetworkProgressInfo(provider, oci_csta, null);
     }
