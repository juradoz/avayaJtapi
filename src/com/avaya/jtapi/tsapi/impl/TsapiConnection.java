   ...
   implements ITsapiConnection, PrivateData, ITsapiConnIDPrivate, LucentV6Connection
 {
   ...
   public final javax.telephony.TerminalConnection[] getTerminalConnections() { return null;}// Byte code:
     ...
     //   57	117	127	finally
     //   120	132	127	finally } 
   public final void disconnect() throws TsapiPrivilegeViolationException, TsapiResourceUnavailableException, TsapiMethodNotSupportedException, TsapiInvalidStateException { TsapiTrace.traceEntry("disconnect[]", this);
     try
     {
   ...
   public final ConnectionCapabilities getCapabilities()
   {
     ...
     try
     {
       ConnectionCapabilities caps = this.tsConnection.getTsapiConnCapabilities();
     ...
     throws TsapiInvalidStateException, TsapiInvalidPartyException, TsapiMethodNotSupportedException, TsapiPrivilegeViolationException, TsapiResourceUnavailableException
   {
     ...
     try
     {
       TSConnection conn = this.tsConnection.redirect(destinationAddress, this.privData);
       Connection connexion;
       if (conn != null)
       {
         connexion = (Connection)TsapiCreateObject.getTsapiObject(conn, true);
   ...
   public final CallCenterTrunk getTrunk()
   {
     ...
     try
     {
       ...
       if (tsTrunk != null)
       {
         trunk = (CallCenterTrunk)TsapiCreateObject.getTsapiObject(tsTrunk, false);
   ...
   public final Object getPrivateData()
   {
     ...
     Object obj = TsapiPromoter.promoteTsapiPrivate((CSTAPrivate)this.tsConnection.getConnPrivateData());
