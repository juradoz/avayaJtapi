   ...
   implements LucentV5Connection
 {
   public boolean equals(Object obj)
   {
     ...
     {
       return this.tsConnection.equals(((LucentV5ACDManagerConnectionImpl)obj).tsConnection);
     }
   ...
   {
     super(_tsConnection);
     TsapiTrace.traceConstruction(this, LucentV5ACDManagerConnectionImpl.class);
   }
   ...
   {
     super.finalize();
     TsapiTrace.traceDestruction(this, LucentV5ACDManagerConnectionImpl.class);
   }
 }
