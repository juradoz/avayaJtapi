   ...
   implements ITsapiTerminal, PrivateData, LucentV5TerminalEx
 {
   ...
   public final javax.telephony.Provider getProvider() { return null;}// Byte code:
     ...
     //   6	38	52	finally
     //   40	57	52	finally } 
   public final Address[] getAddresses() { TsapiTrace.traceEntry("getAddresses[]", this);
     try
     {
       ...
       {
         tsapiAddr[i] = ((Address)TsapiCreateObject.getTsapiObject((TSDevice)tsAddrDevices.elementAt(i), true));
       }
   ...
   public final TerminalConnection[] getTerminalConnections() { return null;}// Byte code:
     ...
     //   57	117	127	finally
     //   120	132	127	finally } 
   public void addObserver(TerminalObserver observer) throws TsapiResourceUnavailableException { TsapiTrace.traceEntry("addObserver[TerminalObserver observer]", this);
     try
     {
   ...
   public TerminalObserver[] getObservers()
   {
     ...
     try
     {
       Vector tsapiTerminalObservers = this.tsDevice.getTerminalObservers();
 
       if ((tsapiTerminalObservers == null) || (tsapiTerminalObservers.size() == 0))
       {
       ...
       {
         TsapiTerminalMonitor obs = (TsapiTerminalMonitor)tsapiTerminalObservers.elementAt(i);
         if (obs.getObserver() != null)
           observers.add(obs.getObserver());
       }
       TsapiTrace.traceExit("getObservers[]", this);
       if (observers.size() > 0) {
         return (TerminalObserver[])observers.toArray(new TerminalObserver[1]);
       }
       return null;
     }
     finally
   ...
   public CallObserver[] getCallObservers()
   {
     ...
     try
     {
       Vector tsapiTerminalCallObservers = this.tsDevice.getTerminalCallObservers();
 
       if ((tsapiTerminalCallObservers == null) || (tsapiTerminalCallObservers.size() == 0))
       {
       ...
       {
         CallObserver callObserver = ((TsapiCallMonitor) obs).getObserver();
   ...
   public void removeCallObserver(CallObserver observer)
   {
     ...
     try
     {
       ...
       {
         TsapiCallMonitor obs = (TsapiCallMonitor)tsapiTerminalCallObservers.elementAt(i);
         if (obs.getObserver() != observer)
           continue;
   ...
   public final TerminalCapabilities getCapabilities()
   {
     ...
     try
     {
       TerminalCapabilities caps = this.tsDevice.getTsapiTerminalCapabilities();
   ...
   public final TerminalConnection pickup(Address pickAddress, Address terminalAddress) throws TsapiInvalidArgumentException, TsapiInvalidStateException, TsapiMethodNotSupportedException, TsapiPrivilegeViolationException, TsapiResourceUnavailableException { return null;}// Byte code:
     ...
     //   6	115	158	finally
     //   118	163	158	finally } 
   public final TerminalConnection pickupFromGroup(String pickupGroup, Address terminalAddress) throws TsapiInvalidArgumentException, TsapiInvalidStateException, TsapiMethodNotSupportedException, TsapiPrivilegeViolationException, TsapiResourceUnavailableException { TsapiTrace.traceEntry("pickupFromGroup[String pickupGroup, Address terminalAddress]", this);
     try
     {
   ...
   public final TerminalConnection pickupFromGroup(Address terminalAddress) throws TsapiInvalidArgumentException, TsapiInvalidStateException, TsapiMethodNotSupportedException, TsapiPrivilegeViolationException, TsapiResourceUnavailableException { return null;}// Byte code:
     ...
     //   6	74	101	finally
     //   77	106	101	finally } 
   public final void setAgents(Agent[] agents) throws TsapiMethodNotSupportedException { TsapiTrace.traceEntry("setAgents[Agent[] agents]", this);
     try
     {
       throw new TsapiMethodNotSupportedException(4, 0, "deprecated method, not supported by implementation");
     }
     finally
     {
       this.privData = null; }  } 
   ...
   public final Agent addAgent(Address agentAddress, ACDAddress acdAddress, int initialState, String agentID, String password) throws TsapiInvalidArgumentException, TsapiInvalidStateException { return null;}// Byte code:
     ...
     //   6	174	189	finally
     //   177	194	189	finally } 
   public final Agent addAgent(LucentAddress agentAddress, ACDAddress acdAddress, int initialState, int workMode, String agentID, String password) throws TsapiInvalidArgumentException, TsapiInvalidStateException { TsapiTrace.traceEntry("addAgent[LucentAddress agentAddress, ACDAddress acdAddress, int initialState, int workMode, String agentID, String password]", this);
     if (agentAddress == null) {
       throw new TsapiInvalidArgumentException(3, 0, "agent Address is null");
     }
 
     Agent agent = addAgent(agentAddress, acdAddress, initialState, workMode, 0, agentID, password);
   ...
   public final Agent addAgent(LucentAddress agentAddress, ACDAddress acdAddress, int initialState, int workMode, int reasonCode, String agentID, String password) throws TsapiInvalidArgumentException, TsapiInvalidStateException { return null;}// Byte code:
     ...
     //   6	173	188	finally
     //   176	193	188	finally } 
   public final void removeAgent(Agent agent) throws TsapiInvalidStateException, TsapiInvalidArgumentException { TsapiTrace.traceEntry("removeAgent[Agent agent]", this);
     removeAgent(agent, 0);
   ...
   public final Agent[] getAgents() { return null;}// Byte code:
     ...
     //   57	117	127	finally
     //   120	132	127	finally } 
   public final void setPrivateData(Object data) { TsapiTrace.traceEntry("setPrivateData[Object data]", this);
     try
     {
     ...
     throws TsapiInvalidArgumentException
   {
     ...
     if (tsProv != null)
     {
       ...
       if ((this.tsDevice == null) || (!this.tsDevice.isTerminal()))
       {
         ...
         throw new TsapiPlatformException(4, 0, "could not create terminal: " + _name + info);
       }
     }
     else
     {
   ...
   public TerminalListener[] getTerminalListeners()
   {
     ...
     try
     {
       ...
       TsapiTrace.traceExit("getTerminalListeners[]", this);
       if (listeners.size() > 0) {
         return (TerminalListener[])listeners.toArray(new TerminalListener[1]);
       }
     ...
     try {
       ...
       synchronized (tsapiTerminalCallObservers) {
         for (Object obs : tsapiTerminalCallObservers) {
           ...
           if (listener != null)
             callListenerList.add(((TsapiCallMonitor) obs).getListener());
         }
       }
