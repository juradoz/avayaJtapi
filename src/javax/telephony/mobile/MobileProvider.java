...
public abstract interface MobileProvider extends Provider
{
  ...
  public abstract MobileNetwork[] getAvailableNetworks(boolean paramBoolean)
    throws MethodNotSupportedException, InvalidStateException, ResourceUnavailableException;
  ...
  public abstract Date getNetworkTime()
 ...
 * Qualified Name:     javax.telephony.mobile.MobileProvider
